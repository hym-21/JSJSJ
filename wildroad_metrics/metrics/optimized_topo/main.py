...
def main():
    ...
    parser.add_argument('-matching_threshold', type=float, default=0.00020, help='topo marble-hole matching distance')
    parser.add_argument('-interval', dest='topo_interval', type=float, default=0.00006, help='topo marble-hole interval')
    ...
    if args.r is not None:
        ...
        r = 0.00250  # 从0.00300降到0.00250
        if lat_top_left - min_lat < 0.01000:
            r = 0.00120  # 从0.00150降到0.00120
